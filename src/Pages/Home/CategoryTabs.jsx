...
const CategoryTabs = () => {
  ...
  return (
    <div>
      ...
      <input
        className="mt-10 border-black border-1 p-2 input input-bordered"
        type="text"
      ...
      <div className="category-content mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
        {isLoading ? (
          ...
          categories.map((item) => {
            if ((selectCategory === item.category || selectCategory === "ALL") && item.job.toLowerCase().includes(searchJobs.toLowerCase())){
              return (
