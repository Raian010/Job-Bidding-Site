...
const Banner = () => {
    return (
      ...
      //   </div>
      // </div>
      <div className="my-10" style={{backgroundImage: 'url(https://i.postimg.cc/wThgtRDZ/low-poly-banner-design-1711.jpg)'}}>
        <div className="flex flex-col lg:flex-row">
        <div className="max-w-sm lg:ml-20 mt-5 md:p-5 ml-5 md:ml-10 lg:p-10">
          <h1 className="mb-5 text-3xl md:text-4xl font-bold">Your gateway to career success</h1>
           <p className="mb-5 font-medium text-base">Welcome to the ultimate job platform where opportunities meet ambition. Whether you're seeking the perfect job or looking to hire top talent, our platform offers a seamless experience. Post jobs with ease, connect with a diverse talent pool, and take your career to new heights. Your next big career move begins here."</p>
          <Link to="/register" className="btn btn-primary">Get Started</Link>
      </div>
      <div>
      <img className="md:ml-32 lg:ml-0 lg:h-[500px]" src="https://i.postimg.cc/rs2yb1SG/List-of-Websites-to-make-image-background-transparent-removebg-preview.png" alt="" />
      </div>
        </div>
      </div>
    );
